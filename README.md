...
## Tags
networking, ports, tcp, udp, winforms, csharp, dotnet, port-scanner, port-monitor, learning-tool
## Description
A small Windows application for reading, monitoring, and analyzing active TCP/UDP ports with a simple graphical interface. Designed for learning, troubleshooting, and exploring low-level networking behavior on Windows systems.
